...
<tr>
	...
	<td valign="top" width="300" style="padding-right:4px;">
		...
		<div id="preview" name="preview" style="position:fixed;top:360px;width:inherit;">
			...
			<!-- validate ZIPCODE -->
			<h2><img src='images/icons/check-alt.png' /> <?php echo LBL_ZIPCODE; ?> </h2>
			<div id="cart"></div>
			<script>
		...
		function showPicture(evt, filename) {
			...
			div_box.innerHTML='<div style="padding:3px; background-color:#FFFFFF;"><img src="'+filename+'" width="450" height="450" /></div>';
			var mx = mouseX(evt);
			var my = mouseY(evt);

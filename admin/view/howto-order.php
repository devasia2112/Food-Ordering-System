...
<html lang="en">
  ...
  <body>
	...
	<table class="zebra-striped">
	  <form method="post" action="../model/howto-order.php">
	      <input type='hidden' value='1' name='submitted' />
	      <input type="hidden" name="id" value="<?=$comp_data[id];?>" />

        <tr><td align="right">Front-end Text</td>
        <td><textarea id="editor1" class="span12" name="content" style="width:100%"><?php echo html_entity_decode($comp_data['frontend1']); ?></textarea></td>
        </tr>

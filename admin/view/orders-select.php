...
<html lang="en">
  ...
  <body>
    <?php include("../menu.php"); ?>
      <div class="content">
		<div class="hero-unit">
          <h1>Consulta/Baixa de Pedidos</h1>
          <p>Abaixo segue a listagem de todos os pedidos cadastrados no sistema com status PENDENTE.</p>
        </div>
            ...
            <tr>
              ...
              <?php include("../model/orders-select.php"); ?>
            </table>

...
session_start();
    ...
    {
        $_SESSION['observation_order'] = mysql_real_escape_string($_POST['observation_order']);
        GenericSql::Redirect($sec=0, $file="../checkout-process.php");
        die('Redirecting Now..');
    }
    // Redirect to the right place checkout-process.php
    if ($_POST['continueorder'])
    {
        ...
        GenericSql::Redirect($sec=0, $file="../menu.php");
        die('Redirecting Now..');
    }
    // Redirect to the right place checkout-process.php

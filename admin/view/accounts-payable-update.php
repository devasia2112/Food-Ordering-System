...
<html lang="en">
  ...
  <body>
	...
	<table class="zebra-striped">
        <?php $array_comp = GenericSql::getInvoicesPayableByID( $id ); ?>
	  <form method="post" action="../model/accounts-payable-update.php">
		  ...
		  <tr><td align="right">&nbsp;</td><td></td></tr>
		  <tr><td align="right">#ID Fatura</td><td><input type="text" maxlength="20" name="orderid" size="20" value="<?=$array_comp['id'];?>" readonly /></td></tr>
		  <tr><td align="right">HASH Pedido</td><td><input type="text" maxlength="20" name="orderid" size="20" value="<?=$array_comp['order_id'];?>" readonly /></td></tr>
		  ...
		  <tr><td align="right">Descri&ccedil;&atilde;o</td><td><input type="text" maxlength="14" name="pagto" size="20" value="<?=$array_comp['desc'];?>" readonly /></td></tr>

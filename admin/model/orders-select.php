...
$query  = "SELECT orders.order_id, orders.customer_id, orders.date_time, orders.payment_method, orders.order_status_id, orders.date_last_modified, customers.name, orders_status.orders_status_name, payment_types.description, orders_observations.scheduling, orders_observations.observation "
	  ."FROM `orders` "
	  ."LEFT JOIN orders_observations ON orders_observations.order_id = orders.order_id "
	  ...
	  ."WHERE order_status_id=1 OR order_status_id=2 OR order_status_id=3 OR order_status_id=4 OR order_status_id=5 OR order_status_id=6 OR order_status_id=7 OR order_status_id=8 OR order_status_id=9 "
...
while($row = mysql_fetch_array($result))
{
    ...
    echo "<td valign='top'>" . nl2br( $row['scheduling']) . "</td>";
    ...
    echo "<td valign='top'>" . nl2br( $row['observation']) . "</td>";
    echo "<td valign='top'>
